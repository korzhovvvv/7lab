...
namespace LabWork7
{
    ...
    class Program
    {
        ...
        {
                new Employee(1,"Крылов",2),
                new Employee(2,"Плюшкин",1),
                new Employee(3,"Цветаев",1),
                new Employee(4,"Печорин",2),
                new Employee(5,"Маркова",1),
                new Employee(6,"Манвелка",3),
                new Employee(7,"Кринжов",2),
                new Employee(8,"Петров",2),
                new Employee(9,"Сидоров",1)
        };
